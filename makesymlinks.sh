...
files="zshrc private Xresources gitignore_global gitconfig profile vimrc shsh vim ideavimrc gvimrc gemrc bash_profile env p10k.zsh"    # list of files/folders to symlink in homedir
